...
const onAuthChange = (createbloglink, loginlink, signuplink, logoutlink, loginwithgoogle) => {
    auth.onAuthStateChanged(user => {
        if(user) {
            ...
            loginwithgoogle.style.display = "inline-block";
...
export {signupAuth, logOutUser, loginUser, onAuthChange, signInUserWithGoogle};
